        ...
        <div className="conatiner-fluid">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <input type="text" className="no-outline" autoComplete="off" placeholder="Enter Full Name*" />
              <div className="org">
              ...
              <div className="org">
                ...
                <input type="text" className="no-outline" autoComplete="off" placeholder="Phone *" />
              </div>
              <div className="org">
...
function Form_contact() {
  ...
  return (
    <>
      <button className='button_style' onClick={() => setModalShow(true)}>
